...
/**
 * Panel representing 1 day in the Week/Agenda View
 *
...
public abstract class WeekDayPanel extends AbstractBasePanel {
	...
	public void setupAccessibleComponents() {
		...
		if (eventsModel.getEventsModel().getNumberOfDays() > 5) dayEventsListView.showEndTime(false);
		else dayEventsListView.showEndTime(true);
